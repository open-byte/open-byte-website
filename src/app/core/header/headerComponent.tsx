        ...
        <header>
            <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <a href="https://open-byte.dev" className="flex items-center">
                        <img src="open-byte.svg" className="mr-3 h-6 sm:h-10" alt="Open Byte" />
                        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Open Byte</span>
                    </a>
